...
public class PracticalTest02MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        serverPortEditText = (EditText)findViewById(R.id.port_name);
        connectButton = (Button)findViewById(R.id.connect_button);
        connectButton.setOnClickListener(connectButtonClickListener);

        clientAddressEditText = (EditText)findViewById(R.id.address_name);
        clientPortEditText = (EditText)findViewById(R.id.port_data);
        informationTypeSpinner = (Spinner)findViewById(R.id.information_type_spinner);
        getValueButton = (Button)findViewById(R.id.value_button);
        getValueButton.setOnClickListener(getValueButtonClickListener);
        valueTextView = (TextView)findViewById(R.id.value_view);
    }
